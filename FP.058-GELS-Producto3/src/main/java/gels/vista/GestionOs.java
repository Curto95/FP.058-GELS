...
public class GestionOs {
     ...
     */
    private void showGestionArticulos() throws TiposObligatoriosExcepciones {
        int codigo;
        String descripcion;
        ...
        controlador.addArticulos(codigo, descripcion, precioProducto, precioEnvio, tiempoPrepEnvio);

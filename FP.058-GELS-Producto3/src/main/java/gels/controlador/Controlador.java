...
public class Controlador {
    ...
    public Controlador() throws excepciones.DbConexionExcepciones{
        datos = new Datos();
    }
     ...
     */
    public void addClientes(String nombre, String domicilio, String nif, String email, int tipoCliente) throws DbConexionExcepciones {
     ...
     */
    public boolean addArticulos(int id_articulo, String descripcion, float precioProducto, float precioEnvio, int tiempoPrepEnvio) throws DbConexionExcepciones {
    return datos.addToListaArticulos(id_articulo, descripcion, precioProducto, precioEnvio, tiempoPrepEnvio);
}
   /* public void addArticulos(int id_articulo, String descripcion, float precioProducto, float precioEnvio, int tiempoPrepEnvio) {
     ...
     */
    public int addPedidos(String nifCliente, int idArticulo, int cantidadArticulo, Date fechaPedido, float precio) throws ClientesExcepciones, ArticulosExcepciones {
        return datos.addToListaPedidos(nifCliente, idArticulo, cantidadArticulo, fechaPedido, false, precio);
    }

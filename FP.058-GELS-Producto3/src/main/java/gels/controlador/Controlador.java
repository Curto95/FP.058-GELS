...
public class Controlador {
   ...
   /* public void addArticulos(int id_articulo, String descripcion, float precioProducto, float precioEnvio, int tiempoPrepEnvio) {
     ...
     */
    public int addPedidos(int idPedido, int Cantidad, Date FechaHora, int articulo, String cli, float precio) throws ClientesExcepciones, ArticulosExcepciones, DbConexionExcepciones {
        return datos.addToListaPedidos(idPedido, Cantidad, FechaHora, articulo, cli, precio);
    }

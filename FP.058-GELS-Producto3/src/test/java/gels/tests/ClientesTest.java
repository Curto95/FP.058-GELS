...
public class ClientesTest {
    ...
    public void testGetEmailEstandar() {
        Clientes c = new ClienteEstandar("Gels2", "Calle de los palotes2", "1234", "gels@gels.gels");
    ...
    public void testGetEmailPremium() {
        Clientes c = new ClientePremium("Gels2", "Calle de los palotes2", "1234", "gels@gels.gels");
        String expResult = "gels@gels.gels";
        String result = c.getEmail();
        assertEquals(expResult, result);
    }
